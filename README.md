...
## Environments
- Preview: https://main--firefly-seo-demo--aemysites.aem.page/
- Live: https://main--firefly-seo-demo--aemysites.aem.live/
- Block Library: https://main--firefly-seo-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `firefly-seo-demo` directory in your favorite IDE and start coding :)
